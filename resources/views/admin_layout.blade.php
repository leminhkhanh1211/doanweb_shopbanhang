...
{{-- <link href="{{ asset('public/backend/ckeditor_vanban/ckeditor5/ckeditor5.css') }}" rel="stylesheet" /> --}}
<link href="{{ asset('public/backend/ckeditor/ckeditor.js') }}" rel="stylesheet" />
...
{{-- <script src="{{ asset('public/backend/ckeditor_vanban/ckeditor5/ckeditor5.js') }}"></script> --}}
...
<script>
    // Lặp qua tất cả các textarea với id bắt đầu bằng 'ckeditor'
    ['ckeditor1', 'ckeditor2','ckeditor3','ckeditor4'].forEach(id => {
        ClassicEditor
            .create(document.querySelector(`#${id}`),{
                ckfinder: {
                uploadUrl: 'upload.php' // Đảm bảo URL này trỏ tới tệp PHP xử lý tải ảnh
        }
            })
            .catch(error => {
                console.error(`Có lỗi xảy ra ở editor ${id}:`, error);
            });
    });
</script>
<script type="text/javascript">
    $(function(){
        ...
        $("#datepicker2").datepicker({
            ...
            nextText:"Tháng sau",
            dateFormat:"yy-mm-dd",
            datNamesMin: ["Thứ 2", "Thứ 3", "Thứ 4", "Thứ 5", "Thứ 6", "Thứ 7", "Chủ nhật"],
            duration:"slow"
        });
    });
...
<script type="text/javascript">
    $('#btn-dashboard-filter').click(function() {
     ...
     $.ajax({
         url: '/shopbanhang/filter-by-date',
         method: "POST",
         dataType: "JSON",
         data: {
             from_date: from_date,
...
<script>
    $(document).ready(function () {
        $.validate(); // Khởi tạo jQuery Form Validator
    });
</script>
<script type="text/javascript">
    ...
    var comment_id = $(this).data('comment_id');
    var comment = $('.reply_comment_' + comment_id).val(); // Sửa cú pháp lựa chọn textarea
    ...
    $.ajax({
        ...
        success: function (data) {
            $('.reply_comment_' + comment_id).val(''); // Làm sạch trường input sau khi thành công
