...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product(){
        $this->AuthLogin();
       $all_category_product= DB::table('categories')->paginate(3);
    ...
    public function edit_category_product($category_product_id){
        $this->AuthLogin();
        $edit_category_product= DB::table('categories')
        ->where('category_id',$category_product_id)
        ->get();
     ...
     public function update_category_product(Request $request,$category_product_id){
        ...
        $data['slug_category_product'] = $request->slug_category_product;
        $data['category_desc'] = $request->category_product_desc;
        DB::table('categories')->where('category_id',$category_product_id) 
        ->update($data);
     ...
     public function show_category_home(Request $request,$slug_category_product) {
      ...
      $category_post= Category_Post::orderBy('cate_post_id','DESC')->get();
        ...
        $category_by_id = DB::table('tbl_product')
        ->join('categories', 'tbl_product.category_id', '=', 'categories.category_id')
        ->where('categories.slug_category_product',$slug_category_product)->paginate(5);
        ...
        $category_name = DB::table('categories')->where('categories.slug_category_product', $slug_category_product)->limit(1)->get();
