...
<div class="w3layouts-main">
	...
	?>
		<form action="{{ url('/register') }}" method="post">
			{{ csrf_field() }}
            <input type="text" class="ggg" name="admin_name" placeholder="Nhập Name" required=""> 
			<input type="text" class="ggg" name="admin_email" placeholder="Nhập Email" required="">
            <input type="text" class="ggg" name="admin_phone" placeholder="Nhập Phone" required="">
