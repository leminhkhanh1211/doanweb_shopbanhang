                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="7" name="brand_product_desc" class="form-control" id="exampleInputPassword1" placeholder="Mô tả danh mục">{{$edit_value->brand_desc}}</textarea>
                        </div>
