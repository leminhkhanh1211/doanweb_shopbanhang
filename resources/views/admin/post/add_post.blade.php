                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="7" name="post_desc" class="form-control" id="ckeditor3" placeholder="Mô tả bài viết"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội dung bài viết</label>
                            <textarea style="resize: none" rows="7" name="post_content" class="form-control" id="ckeditor4" placeholder="Mô tả bài viết"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Meta từ khóa</label>
                            <textarea style="resize: none" rows="5" name="post_meta_keywords" class="form-control" id="exampleInputPassword1" placeholder="Mô tả bài viết"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Meta nội dung</label>
                            <textarea style="resize: none" rows="5" name="post_meta_desc" class="form-control" id="exampleInputPassword1" placeholder="Mô tả bài viết"></textarea>
                        </div>
                        <div class="form-group">
